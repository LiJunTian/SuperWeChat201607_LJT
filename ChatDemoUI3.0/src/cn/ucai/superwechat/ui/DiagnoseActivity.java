...
public class DiagnoseActivity extends BaseActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.superwechat.R.layout.em_activity_diagnose);

		TextView currentVersion = (TextView) findViewById(cn.ucai.superwechat.R.id.tv_version);
		Button uploadLog = (Button) findViewById(cn.ucai.superwechat.R.id.button_uploadlog);
