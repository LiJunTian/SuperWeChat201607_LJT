...
public class VoiceCallActivity extends CallActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(cn.ucai.superwechat.R.layout.em_activity_voice_call);
        ...
        TextView nickTextView = (TextView) findViewById(cn.ucai.superwechat.R.id.tv_nick);
        TextView durationTextView = (TextView) findViewById(cn.ucai.superwechat.R.id.tv_calling_duration);
...
//                                        callStateTextView.setText(st7);
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case cn.ucai.superwechat.R.id.btn_refuse_call:
		    refuseBtn.setEnabled(false);
		    handler.sendEmptyMessage(MSG_CALL_REJECT);
			break;

		case cn.ucai.superwechat.R.id.btn_answer_call:
		...
		case cn.ucai.superwechat.R.id.btn_hangup_call:
		...
		case cn.ucai.superwechat.R.id.iv_mute:
			if (isMuteState) {
			...
			break;
		case cn.ucai.superwechat.R.id.iv_handsfree:
			if (isHandsfreeState) {
