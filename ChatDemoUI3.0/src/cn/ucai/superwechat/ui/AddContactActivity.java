    ...
    private void searchUser(String name) {
        ...
        NetDao.searchUser(this, name, new OkHttpUtils.OnCompleteListener<String>() {
            ...
            public void onSuccess(String s) {
                ...
                if(s!=null){
                    ...
                    if(result!=null&&result.isRetMsg()){
                        ...
                        if(u!=null){
                            MFGT.gotoUserDetailActivity(AddContactActivity.this,u.getMUserName());
                        }
                    }else{
            ...
            public void onError(String error) {
                progressDialog.dismiss();
                L.e("AddContactActivity","error="+error);
                CommonUtils.showShortToast(R.string.msg_104);
            }
        });
    }
...
//    }
    ...
    @OnClick({R.id.register_and_login_title_back,R.id.tv_add})
