	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (type == EMMessage.Type.TXT.ordinal()) {
		    if(message.getBooleanAttribute(Constant.MESSAGE_ATTR_IS_VIDEO_CALL, false)
				...
				setContentView(cn.ucai.superwechat.R.layout.em_context_menu_for_location);
		    }else if(message.getBooleanAttribute(Constant.MESSAGE_ATTR_IS_BIG_EXPRESSION, false)){
		        setContentView(cn.ucai.superwechat.R.layout.em_context_menu_for_image);
		    }else{
		        setContentView(cn.ucai.superwechat.R.layout.em_context_menu_for_text);
		    }
		    ...
		    setContentView(cn.ucai.superwechat.R.layout.em_context_menu_for_voice);
		} else if (type == EMMessage.Type.VIDEO.ordinal()) {
			setContentView(cn.ucai.superwechat.R.layout.em_context_menu_for_video);
		...
		if (isChatroom
				...
				|| message.getBooleanAttribute(RedPacketConstant.MESSAGE_ATTR_IS_RED_PACKET_MESSAGE, false)) {
			    //end of red packet code
			View v = (View) findViewById(cn.ucai.superwechat.R.id.forward);
	        if (v != null) {
